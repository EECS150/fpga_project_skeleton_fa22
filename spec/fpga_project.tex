...
Working alone or in a team of two, you will design and implement a 3-stage pipelined RISC-V CPU with a UART for tethering and a data cache system.
...
\begin{itemize}
  ...
  \item \textbf{\cacheDueDate \space - \cacheTaskName \space (\cacheTimeAlloted)} - Implement a data cache in Verilog.
